...
def main():
    ...
    # even_better_draw_circles(rg.Point(100,50),13,6,'blue',1)
    # even_better_draw_circles(rg.Point(-200,10),25,10,'red',10)

    better_draw_circles(rg.Point(0,0),20)
    even_better_draw_circles(rg.Point(-100,0),10,10,'blue',3)
    even_better_draw_circles(rg.Point(100, 0), 10, 10, 'red', 3)
    even_better_draw_circles(rg.Point(0,100), 10, 10, 'yellow', 3)
    even_better_draw_circles(rg.Point(0, -100), 10, 10, 'green', 3)
...
def even_better_draw_circles(point, radius, number_of_circles, trail_color, trail_thickness):
    """ An improved version of draw_circles, per the _TODO_ above. """
    # READ the above _TODO_ and then copy-paste code from better_circles here:  turtle = rg.SimpleTurtle()
    turtle = rg.SimpleTurtle()
    turtle.pen = rg.Pen(trail_color, trail_thickness)
    turtle.pen_up()
    turtle.go_to(point)
    turtle.set_heading(0)  # Point "east" (towards the right)
    c = number_of_circles + 1
